...
const imagePath = './frontend/public/userUploads/'
...
const updateCart = asyncHandler(async(req, res)=>{
    if(req.user!==null){
        try {
            const user = await User.findById(req.user._id)
            user.cart = user.cart.filter(item=>item.productId.toString() !== req.params.productId.toString())
            user.save()
            res.json({
                Status : "Success",
...
module.exports = {registerUser, authUser, addToCart, placeOrder, getCart, getOrders, updateCart, buyNow}