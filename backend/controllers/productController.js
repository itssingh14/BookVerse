...
const fs = require('fs')
const imagePath = "./frontend/public/productUploads/"
...
const addProduct = asyncHandler(async(req, res)=>{
    ...
    if(req.user !== null && req.user.isAdmin){
        const {name, author, ratings, genre, description, price, productCode, inStock} = req.body
        if(!name || !author || !ratings || !genre || !description || !price || !productImage || !productCode){
            res.json({
                Status : "Failed",
